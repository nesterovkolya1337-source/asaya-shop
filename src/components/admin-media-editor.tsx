...
export function AdminMediaEditor(props:Props){
 ...
 return <section aria-label="Загрузка фотографий"><p>JPG, PNG или WebP до 6 МБ. Основное фото и до {maxGallery} фото в галерее. После загрузки сохраните и опубликуйте карточку.</p>
