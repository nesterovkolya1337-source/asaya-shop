import {selectRecommendations,temporaryPdpRecommendationIds} from './recommendations.ts';
...
export function pdpRecommendations(products:Product[],product:Product){
 return selectRecommendations(products,[product.id],temporaryPdpRecommendationIds(product));
}
