...
const recommendationMap: Record<string, string[]> = {
  ...
  "hair-duo-set": ["hair-shampoo", "hair-balm", "multi-hair-spray", "hair-mask"],
  "hair-trio-spray-set": ["multi-hair-spray", "hair-shampoo", "hair-balm", "hair-mask"],
  "hair-trio-mask-set": ["hair-cream-spray", "hair-shampoo", "hair-balm", "hair-mask"],
};
...
export const defaultProducts: Product[] = [
  ...
  createProduct({
    id: "hair-duo-set",
    name: "Набор для волос: шампунь и бальзам",
    description: "Базовый дуэт для ежедневного очищения, увлажнения и гладкости волос: шампунь бережно очищает, а бальзам помогает сделать длину мягкой, послушной и сияющей.",
    volume: "2 средства",
    features: ["Ежедневное очищение", "Мягкость и гладкость", "Выгодный комплект"],
    usage: "Сначала нанесите шампунь на влажные волосы, вспеньте и тщательно смойте. Затем распределите бальзам по длине, оставьте на 2–3 минуты и смойте водой.",
    ingredients: "В набор входят шампунь для волос 300 мл и бальзам для волос 300 мл. Полные составы указаны на страницах каждого средства и на упаковке.",
    aroma: hairAroma,
    instruction: {
      steps: ["Намочите волосы и вспеньте шампунь у корней.", "Тщательно смойте пену водой.", "Распределите бальзам по длине и кончикам.", "Оставьте на 2–3 минуты и смойте."],
      amount: "Для каждого этапа начните с порции размером с небольшую монету.",
      tip: "Не наносите бальзам на корни, если хотите сохранить прикорневой объём.",
    },
    category: "sets",
    price: 900,
    oldPrice: 1200,
    discount: 25,
    badge: "Бестселлер",
    image: assetPath("/images/figma/set-products/hair-duo.webp"),
    gallery: [
      assetPath("/images/figma/set-products/hair-duo.webp"),
      assetPath("/images/figma/product-galleries/hair-shampoo/1.webp"),
      assetPath("/images/figma/product-galleries/hair-balm/1.webp"),
    ],
  }),
  createProduct({
    id: "hair-trio-spray-set",
    name: "Набор для волос: шампунь, бальзам и мульти спрей",
    description: "Полный ежедневный ритуал для очищения, гладкости и термозащиты: шампунь, бальзам и несмываемый мульти спрей 15 в 1.",
    volume: "3 средства",
    features: ["Полный ритуал ухода", "Термозащита до 230 °C", "Выгодный комплект"],
    usage: "Вымойте волосы шампунем, нанесите бальзам и смойте. На подсушенную полотенцем длину распылите мульти спрей с расстояния 15–20 см и приступайте к укладке.",
    ingredients: "В набор входят шампунь 300 мл, бальзам 300 мл и мульти спрей для волос 200 мл. Полные составы указаны на страницах каждого средства и на упаковке.",
    aroma: hairAroma,
    instruction: {
      steps: ["Вымойте волосы шампунем.", "Нанесите бальзам на длину и тщательно смойте.", "Промокните волосы полотенцем.", "Распылите мульти спрей и приступайте к укладке."],
      amount: "Шампунь и бальзам — по небольшой порции; спрей — лёгкой равномерной вуалью по длине.",
      tip: "Перед горячей укладкой распределите спрей расчёской, чтобы защита покрыла всю длину.",
    },
    category: "sets",
    price: 1300,
    oldPrice: 1900,
    discount: 32,
    badge: "Бестселлер",
    image: assetPath("/images/figma/set-products/hair-trio-spray.webp"),
    gallery: [
      assetPath("/images/figma/set-products/hair-trio-spray.webp"),
      assetPath("/images/figma/product-galleries/hair-shampoo/1.webp"),
      assetPath("/images/figma/product-galleries/hair-balm/1.webp"),
      assetPath("/images/figma/product-galleries/multi-hair-spray/1.webp"),
    ],
  }),
  createProduct({
    id: "hair-trio-mask-set",
    name: "Набор для волос: шампунь, бальзам и спрей-маска",
    description: "Три средства для очищения, увлажнения и дисциплины волос, включая несмываемую спрей-маску для мягкости и лёгкого расчёсывания.",
    volume: "3 средства",
    features: ["Увлажнение и питание", "Лёгкое расчёсывание", "Выгодный комплект"],
    usage: "Вымойте волосы шампунем, нанесите бальзам и смойте. На подсушенную полотенцем длину распылите спрей-маску, расчешите волосы и выполните укладку.",
    ingredients: "В набор входят шампунь 300 мл, бальзам 300 мл и спрей-маска для волос 200 мл. Полные составы указаны на страницах каждого средства и на упаковке.",
    aroma: hairAroma,
    instruction: {
      steps: ["Вымойте волосы шампунем.", "Нанесите бальзам на длину и смойте.", "Промокните волосы полотенцем.", "Нанесите спрей-маску, расчешите и уложите волосы."],
      amount: "Используйте небольшие порции и добавляйте средство только при необходимости.",
      tip: "На кудрявых волосах наносите спрей-маску перед формированием завитка.",
    },
    category: "sets",
    price: 1300,
    oldPrice: 1900,
    discount: 32,
    image: assetPath("/images/figma/set-products/hair-trio-mask.webp"),
    gallery: [
      assetPath("/images/figma/set-products/hair-trio-mask.webp"),
      assetPath("/images/figma/product-galleries/hair-shampoo/1.webp"),
      assetPath("/images/figma/product-galleries/hair-balm/1.webp"),
      assetPath("/images/figma/product-galleries/hair-cream-spray/1.webp"),
    ],
  }),
