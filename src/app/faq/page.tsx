...
const questions = [
  ...
  ["Можно ли оставить отзыв?", "Да. В рабочем прототипе войдите по email, поставьте оценку, добавьте текст и до двух фотографий. Отзыв появится после модерации. На запуске добавим защищённый вход и отметку подтверждённой покупки."],
