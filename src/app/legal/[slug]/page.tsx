...
const documents = {
  privacy: {
    ...
    sections: [
      ...
      { title: "Права пользователя и контакты оператора", text: `Запросить сведения, исправление или удаление данных, а также отозвать согласие можно по адресу ${companyData.email} или телефону ${companyData.phone}.` },
    ],
  },
  "personal-data": {
    ...
    sections: [
      ...
      { title: "Порядок отзыва согласия", text: `Отзыв можно направить на ${companyData.email}. В обращении нужно указать данные, позволяющие найти ранее оставленную заявку или заказ.` },
    ],
  },
  offer: {
    title: "Публичная оферта",
    sections: [
      { title: "Сведения о продавце", text: `${companyData.fullName}\nИНН/КПП: ${companyData.inn}/${companyData.kpp} · ОГРН: ${companyData.ogrn}\nАдрес: ${companyData.legalAddress}\nТелефон: ${companyData.phone} · Email: ${companyData.email}` },
      ...
      { title: "Возврат, претензии и ответственность", text: `По вопросам повреждения, несоответствия заказа и возврата нужно обратиться по адресу ${companyData.email} или телефону ${companyData.phone}, сохранив товар, упаковку и подтверждение покупки.` },
    ],
  },
  cookies: {
