...
export default function SupportPage() {
  return <InfoPage eyebrow="ASAYA / Помощь" title="Служба заботы" lead={`Поможем подобрать уход, разобраться с применением и заказом. Официальная почта: ${companyData.email}`} action={{ href: "https://t.me/asayahelp", label: "Написать в Telegram" }} sections={[
    ...
    { number: "04", title: "Telegram, MAX и email", text: `Telegram: @asayahelp. Email: ${companyData.email}. Официальную ссылку поддержки в MAX добавим сразу после её передачи владельцем канала.` },
  ]} />;
}
