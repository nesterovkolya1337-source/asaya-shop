...
- `/admin` — управление ценами, скидками, остатками, категориями и порядком товаров
...
- На GitHub Pages корзина, профиль и изменения из `/admin` сохраняются в браузере. Для защищённой авторизации и синхронизации между устройствами нужен серверный этап с базой данных.
