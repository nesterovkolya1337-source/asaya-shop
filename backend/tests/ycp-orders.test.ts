...
async function fixture(cod=false){
 ...
 await checkout.create({session_id:'session',warehouse_id:warehouse,items:[{id:'YCP-A',quantity:2,regular_price:10000,final_price:10000},{id:'YCP-B',quantity:1,regular_price:10000,final_price:10000}],customer:{full_name:'Private Name',phone:'+79990000000',email:'private@example.test'},delivery:{delivery_method:'courier',service_type:'yandex_delivery',price:1000,address:{locality:'Москва',address:'Private street'},delivery_date_interval:{start_interval:{date:'2026-09-09'},end_interval:{date:'2026-09-10'},time_zone:3}}});
