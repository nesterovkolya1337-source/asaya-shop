...
test('draft publication is explicit, edits stay private, stale revisions and duplicate SKUs are rejected',async()=>{
 ...
 assert.equal((await commerce.catalog())[0]!.name,d.name);
